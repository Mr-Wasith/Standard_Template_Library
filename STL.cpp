...
int main()
{
    ...
    cout << "Lower bound of 3: " << *lower << '\n';

    // upper_bound
    auto upper = upper_bound(v.begin(), v.end(), 3);
    cout << "Upper bound of 3: " << *upper << '\n';

    // equal_range
    auto range = equal_range(v.begin(), v.end(), 3);
    cout << "Equal range of 3: [" << *range.first << ", " << *range.second << "]\n";

    // next_permutation
    next_permutation(v.begin(), v.end());
    cout << "Vector after next_permutation: ";
    for (int num : v)
    {
        cout << num << " ";
    }
    ...
    cout << "Vector after prev_permutation: ";
    for (int num : v)
    {
        cout << num << " ";
    }
